...
SMOKE_SCRIPTS = frozenset({
    ...
    ".github/scripts/smoke_repair_bridge.py",
    ".github/scripts/smoke_repair_bundle.py",
    ".github/scripts/smoke_repair_cycle_bridge.py",
    ".github/scripts/smoke_repair_cycle_context.py",
    ".github/scripts/smoke_repair_evidence.py",
    ".github/scripts/smoke_repair_fleet.py",
    ...
    ".github/scripts/smoke_repair_session.py",
    ".github/scripts/smoke_repair_upstream.py",
...
SMOKE_SUPPORT = frozenset({
    ...
    ".github/workflows/smoke-repair-receive.yml",
    ".github/workflows/smoke-repair-cycle.yml",
