...
class PackageWorkflowSupplyChainTests(unittest.TestCase):
    ...
    def test_inventory_has_no_unresolved_reference(self) -> None:
        ...
        self.assertEqual(
            "fadcf146d6fd87ebc10c75dbaf0c8ec35af3696be0dbe368cff9b28ab3e5fb5c",
    ...
    def test_legitimate_advanced_hardened_base_is_accepted(self) -> None:
        ...
        self.assertEqual(
            "a2d0753ae893fd237ce2ddd2284140b1de82cf84fcea2dc72a5c490bf2fe1b7b",
        ...
        self.assertEqual(
            {
                ...
                "workflow_sha256": "a2d0753ae893fd237ce2ddd2284140b1de82cf84fcea2dc72a5c490bf2fe1b7b",
            },
            supply_chain.validate_hardening(
                self.root,
