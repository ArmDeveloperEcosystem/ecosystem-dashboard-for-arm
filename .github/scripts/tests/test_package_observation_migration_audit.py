...
class PackageObservationMigrationAuditTests(unittest.TestCase):
    ...
    def test_remediation_counts_are_explicit_and_reproducible(self) -> None:
        ...
        self.assertEqual(
            {"test3": 1, "test4": 1, "test5": 2, "test6": 325},
            {
                key: len(value)
        ...
        self.assertEqual(
            {"core_failed": 385, "duration": 3, "skipped": 708},
            {
                key: len(value)
        ...
        self.assertEqual(
            310, len(remediation["package_manager_summary_omits_test6"])
        )
        ...
        self.assertEqual(
            410, len(remediation["package_manager_missing_baseline_guard"])
        )
        self.assertEqual(
        ...
        self.assertEqual(328, len(remediation["summary_omits_test6_status"]))
        self.assertEqual(
    ...
    def test_report_is_canonical_json_without_absolute_paths(self) -> None:
        ...
        self.assertEqual(
            "eae1fa55515f9c065ef49a064c734804621370a8ff011674943ca865938e9783",
            digest,
        )
