...
class PackageObservationMigrationAuditTests(unittest.TestCase):
    ...
    def test_remediation_counts_are_explicit_and_reproducible(self) -> None:
        ...
        self.assertEqual(
            {"test3": 1, "test4": 1, "test5": 2, "test6": 334},
            {
                key: len(value)
        ...
        self.assertEqual(
            {"core_failed": 392, "duration": 3, "skipped": 715},
            {
                key: len(value)
        ...
        self.assertEqual(
            317, len(remediation["package_manager_summary_omits_test6"])
        )
        ...
        self.assertEqual(
            425, len(remediation["package_manager_missing_baseline_guard"])
        )
        self.assertEqual(
        ...
        self.assertEqual(335, len(remediation["summary_omits_test6_status"]))
        self.assertEqual(
    ...
    def test_report_is_canonical_json_without_absolute_paths(self) -> None:
        ...
        self.assertEqual(
            "0223c56609086131e0ff0627f474d0d9262c3e2bf5f31db8fc5890d5ab7df00d",
            digest,
        )
