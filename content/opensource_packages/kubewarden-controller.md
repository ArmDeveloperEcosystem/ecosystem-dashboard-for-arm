---
name: Kubewarden-Controller - Developed by Rancher (now part of SUSE)
category: Containers and Orchestration
description: Kubewarden-Controller is a Kubernetes controller that dynamically manages and reconciles Kubewarden admission policies with cluster webhooks. Kubewarden, originally created by SUSE Rancher, is a Kubernetes Policy Engine.
