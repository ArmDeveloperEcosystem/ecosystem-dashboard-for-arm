...
optional_info:
    homepage_url: https://github.com/gardener/machine-controller-manager
    support_caveats:
    alternative_options:
    getting_started_resources:
        official_docs: https://github.com/gardener/machine-controller-manager/tree/master/docs
        arm_content:
        partner_content:
...
optional_hidden_info:
    release_notes__supported_minimum: https://github.com/gardener/machine-controller-manager/releases/tag/v0.46.0
