---
name: SUSE Storage (Longhorn/SUSE Rancher Prime)
vendor: SUSE
category: Storage
description: SUSE Storage is a lightweight, Kubernetes-native distributed block storage solution offering high availability, incremental snapshots, automated backups, and non-disruptive upgrades — fully integrated with SUSE Rancher Prime to simplify persistent storage management across cloud-native environments.
